...
export function AutoIngestDebugPanel({ events }: { events: Array<ClaimLensEvent | SearchStreamEvent> }) {
...
export function getToolResultArray<T = unknown>(events: ClaimLensEvent[], tool: string, key: string): T[] {
